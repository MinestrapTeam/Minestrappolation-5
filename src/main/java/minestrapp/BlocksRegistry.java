...
public class BlocksRegistry {
	...
	public static void init(){
		...
		register(block_irradiant_sunstone = new BlockIrradiantSunstone("block_irradiant_sunstone", Material.GLASS, MapColor.LIME, SoundType.GLASS, null, 0, 20, 4).setHardness(0.3F).setLightLevel(1.0F).setCreativeTab(Tabs.utility));
		register(block_irradium = new BlockIrradium("block_irradium", Material.ROCK, MapColor.LIME, SoundType.STONE, "pickaxe", 1, 20, 4).setHardness(3.5F).setResistance(5.0F).setCreativeTab(Tabs.resource));
