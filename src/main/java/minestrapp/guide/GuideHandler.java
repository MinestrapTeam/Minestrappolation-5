...
public class GuideHandler {
	...
	public static void preInit(){
		...
		plant.addEntry(new GuideEntry("brown_mushroom_block", "Brown Mushroom Block", new ItemStack(Blocks.BROWN_MUSHROOM_BLOCK), 32+(1*16), 84));
		manager.registerInfoPage("brown_mushroom_block", new GuideInfoPage("brown_mushroom_block", EnumPageType.INFO));
		plant.addEntry(new GuideEntry("red_mushroom_block", "Red Mushroom Block", new ItemStack(Blocks.RED_MUSHROOM_BLOCK), 32+(2*16), 84));
		manager.registerInfoPage("red_mushroom_block", new GuideInfoPage("red_mushroom_block", EnumPageType.INFO));
		plant.addEntry(new GuideEntry("reeds", "Sugar Cane", new ItemStack(Items.REEDS), 32+(3*16), 84));
		manager.registerInfoPage("reeds", new GuideInfoPage("reeds", EnumPageType.INFO));
		plant.addEntry(new GuideEntry("cactus", "Cactus", new ItemStack(Blocks.CACTUS), 32+(4*16), 84));
		manager.registerInfoPage("cactus", new GuideInfoPage("cactus", EnumPageType.INFO));
		plant.addEntry(new GuideEntry("pumpkin", "Pumpkin", new ItemStack(Blocks.PUMPKIN), 32+(5*16), 84));
		manager.registerInfoPage("pumpkin", new GuideInfoPage("pumpkin", EnumPageType.INFO));
		plant.addEntry(new GuideEntry("sponge", "Sponge", new ItemStack(Blocks.SPONGE, 0, 0), 32+(6*16), 84));
		manager.registerInfoPage("sponge", new GuideInfoPage("sponge", EnumPageType.INFO));
		plant.addEntry(new GuideEntry("wet_sponge", "Wet Sponge", new ItemStack(Blocks.SPONGE, 0, 1), 32+(7*16), 84));
		...
		soil.addEntry(new GuideEntry("clay", "Clay", new ItemStack(Blocks.CLAY), 32+(6*16), 32));
		manager.registerInfoPage("clay", new GuideInfoPage("clay", EnumPageType.INFO));
		soil.addEntry(new GuideEntry("gravel", "Gravel", new ItemStack(Blocks.GRAVEL), 32+(7*16), 32));
		manager.registerInfoPage("gravel", new GuideInfoPage("gravel", EnumPageType.INFO));
		soil.addEntry(new GuideEntry("soul_sand", "Soul Sand", new ItemStack(Blocks.SOUL_SAND), 32+(8*16), 32));
		...
		stone.addEntry(new GuideEntry("netherrack", "Netherrack", new ItemStack(Blocks.NETHERRACK), 32+(5*16), 32));
		manager.registerInfoPage("netherrack", new GuideInfoPage("netherrack", EnumPageType.INFO));
		stone.addEntry(new GuideEntry("glowstone", "Glowstone", new ItemStack(Blocks.GLOWSTONE), 32+(6*16), 32));
		manager.registerInfoPage("glowstone", new GuideInfoPage("glowstone", EnumPageType.INFO));
		stone.addEntry(new GuideEntry("obsidian", "Obsidian", new ItemStack(Blocks.OBSIDIAN), 32+(7*16), 32));
		manager.registerInfoPage("obsidian", new GuideInfoPage("obsidian", EnumPageType.INFO));
		stone.addEntry(new GuideEntry("bedrock", "Bedrock", new ItemStack(Blocks.BEDROCK), 32+(8*16), 32));
		...
		stone_building.addEntry(new GuideEntry("quartz_slab", "Nether Quartz Slab", new ItemStack(Blocks.STONE_SLAB, 1, 7), 32+(9*16), 58));
		manager.registerInfoPage("quartz_slab", new GuideInfoPage("quartz_slab", EnumPageType.INFO));
		stone_building.addEntry(new GuideEntry("quartz_stairs", "Nether Quartz Stairs", new ItemStack(Blocks.QUARTZ_STAIRS), 32+(10*16), 58));
		manager.registerInfoPage("quartz_stairs", new GuideInfoPage("quartz_stairs", EnumPageType.INFO));
		stone_building.addEntry(new GuideEntry("purpur_slab", "Purpur Tile Slab", new ItemStack(Blocks.PURPUR_SLAB, 1, 0), 32+(11*16), 58));
		manager.registerInfoPage("purpur_slab", new GuideInfoPage("purpur_slab", EnumPageType.INFO));
		stone_building.addEntry(new GuideEntry("purpur_stairs", "Purpur Tile Stairs", new ItemStack(Blocks.PURPUR_STAIRS), 32+(12*16), 58));
		...
		decor.addEntry(new GuideEntry("oak_fence", "Oak Plank Fence", new ItemStack(Blocks.OAK_FENCE), 32+(2*16), 32));
		manager.registerInfoPage("oak_fence", new GuideInfoPage("oak_fence", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("spruce_fence", "Spruce Plank Fence", new ItemStack(Blocks.SPRUCE_FENCE), 32+(3*16), 32));
		manager.registerInfoPage("spruce_fence", new GuideInfoPage("spruce_fence", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("birch_fence", "Birch Plank Fence", new ItemStack(Blocks.BIRCH_FENCE), 32+(4*16), 32));
		manager.registerInfoPage("birch_fence", new GuideInfoPage("birch_fence", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("jungle_fence", "Jungle Plank Fence", new ItemStack(Blocks.JUNGLE_FENCE), 32+(5*16), 32));
		manager.registerInfoPage("jungle_fence", new GuideInfoPage("jungle_fence", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("acacia_fence", "Acacia Plank Fence", new ItemStack(Blocks.ACACIA_FENCE), 32+(6*16), 32));
		manager.registerInfoPage("acacia_fence", new GuideInfoPage("acacia_fence", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("dark_oak_fence", "Dark Oak Plank Fence", new ItemStack(Blocks.DARK_OAK_FENCE), 32+(7*16), 32));
		manager.registerInfoPage("dark_oak_fence", new GuideInfoPage("dark_oak_fence", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("nether_brick_fence", "Nether Brick Fence", new ItemStack(Blocks.NETHER_BRICK_FENCE), 32+(8*16), 32));
		manager.registerInfoPage("nether_brick_fence", new GuideInfoPage("nether_brick_fence", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("trapdoor", "Wooden Trapdoor", new ItemStack(Blocks.TRAPDOOR), 32+(9*16), 32));
		manager.registerInfoPage("trapdoor", new GuideInfoPage("trapdoor", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("oak_door", "Oak Door", new ItemStack(Items.OAK_DOOR), 32+(10*16), 32));
		manager.registerInfoPage("oak_door", new GuideInfoPage("oak_door", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("spruce_door", "Spruce Door", new ItemStack(Items.SPRUCE_DOOR), 32+(11*16), 32));
		manager.registerInfoPage("spruce_door", new GuideInfoPage("spruce_door", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("birch_door", "Birch Door", new ItemStack(Items.BIRCH_DOOR), 32+(12*16), 32));
		manager.registerInfoPage("birch_door", new GuideInfoPage("birch_door", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("jungle_door", "Jungle Door", new ItemStack(Items.JUNGLE_DOOR), 32+(13*16), 32));
		manager.registerInfoPage("jungle_door", new GuideInfoPage("jungle_door", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("acacia_door", "Acacia Door", new ItemStack(Items.ACACIA_DOOR), 32+(14*16), 32));
		manager.registerInfoPage("acacia_door", new GuideInfoPage("acacia_door", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("dark_oak_door", "Dark Oak Door", new ItemStack(Items.DARK_OAK_DOOR), 32+(15*16), 32));
		manager.registerInfoPage("dark_oak_door", new GuideInfoPage("dark_oak_door", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("iron_door", "Iron Door", new ItemStack(Items.IRON_DOOR), 32+(0*16), 58));
		manager.registerInfoPage("iron_door", new GuideInfoPage("iron_door", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("lit_pumpkin", "Glow-Pumpkin", new ItemStack(Blocks.LIT_PUMPKIN), 32+(1*16), 58));
		...
		utility.addEntry(new GuideEntry("chest", "Chest", new ItemStack(Blocks.CHEST), 32+(3*16), 32));
		manager.registerInfoPage("chest", new GuideInfoPage("chest", EnumPageType.INFO));
		utility.addEntry(new GuideEntry("bed", "Bed", new ItemStack(Items.BED), 32+(4*16), 32));
		manager.registerInfoPage("bed", new GuideInfoPage("bed", EnumPageType.INFO));
		utility.addEntry(new GuideEntry("jukebox", "Jukebox", new ItemStack(Blocks.JUKEBOX), 32+(5*16), 32));
		manager.registerInfoPage("jukebox", new GuideInfoPage("jukebox", EnumPageType.INFO));
		utility.addEntry(new GuideEntry("tnt", "TNT", new ItemStack(Blocks.TNT), 32+(6*16), 32));
		manager.registerInfoPage("tnt", new GuideInfoPage("tnt", EnumPageType.INFO));
		utility.addEntry(new GuideEntry("monster_egg_stone", "Stone Silverfish Burrow", new ItemStack(Blocks.MONSTER_EGG, 0, 0), 32+(7*16), 32));
		manager.registerInfoPage("monster_egg_stone", new GuideInfoPage("monster_egg_stone", EnumPageType.INFO));
		utility.addEntry(new GuideEntry("monster_egg_cobblestone", "Cobblestone Silverfish Burrow", new ItemStack(Blocks.MONSTER_EGG, 0, 1), 32+(8*16), 32));
		manager.registerInfoPage("monster_egg_cobblestone", new GuideInfoPage("monster_egg_cobblestone", EnumPageType.INFO));
		utility.addEntry(new GuideEntry("monster_egg_stonebrick", "Stone Brick Silverfish Burrow", new ItemStack(Blocks.MONSTER_EGG, 0, 2), 32+(9*16), 32));
		manager.registerInfoPage("monster_egg_stonebrick", new GuideInfoPage("monster_egg_stonebrick", EnumPageType.INFO));
		utility.addEntry(new GuideEntry("monster_egg_mossy_stonebrick", "Mossy Stone Brick Silverfish Burrow", new ItemStack(Blocks.MONSTER_EGG, 0, 3), 32+(10*16), 32));
		manager.registerInfoPage("monster_egg_mossy_stonebrick", new GuideInfoPage("monster_egg_mossy_stonebrick", EnumPageType.INFO));
		utility.addEntry(new GuideEntry("monster_egg_cracked_stonebrick", "Cracked Stone Brick Silverfish Burrow", new ItemStack(Blocks.MONSTER_EGG, 0, 4), 32+(11*16), 32));
		...
		utility.addEntry(new GuideEntry("monster_egg_chiseled_stonebrick", "Chiseled Stone Silverfish Burrow", new ItemStack(Blocks.MONSTER_EGG, 0, 5), 32+(12*16), 32));
		...
		utility.addEntry(new GuideEntry("mob_spawner", "Monster Spawner", new ItemStack(Blocks.MOB_SPAWNER), 32+(13*16), 32));
		...
		redstone.addEntry(new GuideEntry("redstone_torch", "Redstone Torch", new ItemStack(Blocks.REDSTONE_TORCH), 32+(5*16), 32));
		manager.registerInfoPage("redstone_torch", new GuideInfoPage("redstone_torch", EnumPageType.INFO));
		redstone.addEntry(new GuideEntry("redstone", "Redstone", new ItemStack(Items.REDSTONE), 32+(6*16), 32));
		manager.registerInfoPage("redstone", new GuideInfoPage("redstone", EnumPageType.INFO));
		redstone.addEntry(new GuideEntry("redstone_repeater", "Redstone Repeater", new ItemStack(Items.REPEATER), 32+(7*16), 32));
		manager.registerInfoPage("redstone_repeater", new GuideInfoPage("redstone_repeater", EnumPageType.INFO));
		redstone.addEntry(new GuideEntry("rail", "Rail", new ItemStack(Blocks.RAIL), 32+(8*16), 32));
		manager.registerInfoPage("rail", new GuideInfoPage("rail", EnumPageType.INFO));
		redstone.addEntry(new GuideEntry("golden_rail", "Powered Rail", new ItemStack(Blocks.GOLDEN_RAIL), 32+(9*16), 32));
		manager.registerInfoPage("golden_rail", new GuideInfoPage("golden_rail", EnumPageType.INFO));
		redstone.addEntry(new GuideEntry("detector_rail", "Detector Rail", new ItemStack(Blocks.DETECTOR_RAIL), 32+(10*16), 32));
		manager.registerInfoPage("detector_rail", new GuideInfoPage("detector_rail", EnumPageType.INFO));
		redstone.addEntry(new GuideEntry("piston", "Piston", new ItemStack(Blocks.PISTON), 32+(11*16), 32));
		manager.registerInfoPage("piston", new GuideInfoPage("piston", EnumPageType.INFO));
		redstone.addEntry(new GuideEntry("sticky_piston", "Sticky Piston", new ItemStack(Blocks.STICKY_PISTON), 32+(12*16), 32));
		manager.registerInfoPage("sticky_piston", new GuideInfoPage("sticky_piston", EnumPageType.INFO));
		redstone.addEntry(new GuideEntry("dispenser", "Dispenser", new ItemStack(Blocks.DISPENSER), 32+(13*16), 32));
		manager.registerInfoPage("dispenser", new GuideInfoPage("dispenser", EnumPageType.INFO));
		redstone.addEntry(new GuideEntry("noteblock", "Note Block", new ItemStack(Blocks.NOTEBLOCK), 32+(14*16), 32));
		...
		machine.addEntry(new GuideEntry("furnace", "Furnace", new ItemStack(Blocks.FURNACE), 32+(1*16), 32));
