...
public class GuideHandler {
	...
	public static void preInit(){
		...
		plant.addEntry(new GuideEntry("chorus_plant", "Chorus Plant", new ItemStack(Blocks.CHORUS_PLANT), 32+(11*16), 84));
		manager.registerInfoPage("chorus_plant", new GuideInfoPage("chorus_plant", EnumPageType.INFO));
		plant.addEntry(new GuideEntry("chorus_flower", "Chorus Flower", new ItemStack(Blocks.CHORUS_FLOWER), 32+(12*16), 84));
		manager.registerInfoPage("chorus_flower", new GuideInfoPage("chorus_flower", EnumPageType.INFO));
		...
		frost.addEntry(new GuideEntry("packed_ice", "Packed Ice", new ItemStack(Blocks.PACKED_ICE), 32+(3*16), 32));
		manager.registerInfoPage("packed_ice", new GuideInfoPage("packed_ice", EnumPageType.INFO));
		...
		stone.addEntry(new GuideEntry("red_sandstone", "Red Sandstone", new ItemStack(Blocks.RED_SANDSTONE, 0, 0), 32+(5*16), 32));
		manager.registerInfoPage("red_sandstone", new GuideInfoPage("red_sandstone", EnumPageType.INFO));
		stone.addEntry(new GuideEntry("hardened_clay", "Hardened Clay", new ItemStack(Blocks.HARDENED_CLAY), 32+(6*16), 32));
		manager.registerInfoPage("hardened_clay", new GuideInfoPage("hardened_clay", EnumPageType.INFO));
		stone.addEntry(new GuideEntry("prismarine", "Prismarine", new ItemStack(Blocks.PRISMARINE, 0, 0), 32+(7*16), 32));
		...
		stone.addEntry(new GuideEntry("end_stone", "End Stone", new ItemStack(Blocks.END_STONE), 32+(11*16), 32));
		manager.registerInfoPage("end_stone", new GuideInfoPage("end_stone", EnumPageType.INFO));
		stone.addEntry(new GuideEntry("obsidian", "Obsidian", new ItemStack(Blocks.OBSIDIAN), 32+(12*16), 32));
		manager.registerInfoPage("obsidian", new GuideInfoPage("obsidian", EnumPageType.INFO));
		stone.addEntry(new GuideEntry("bedrock", "Bedrock", new ItemStack(Blocks.BEDROCK), 32+(13*16), 32));
		...
		resource.addEntry(new GuideEntry("iron_block", "Block of Iron", new ItemStack(Blocks.IRON_BLOCK), 32+(5*16), 32));
		manager.registerInfoPage("iron_block", new GuideInfoPage("iron_block", EnumPageType.INFO));
		resource.addEntry(new GuideEntry("gold_block", "Block of Gold", new ItemStack(Blocks.GOLD_BLOCK), 32+(6*16), 32));
		manager.registerInfoPage("gold_block", new GuideInfoPage("gold_block", EnumPageType.INFO));
		resource.addEntry(new GuideEntry("lapis_block", "Lapis Lazuli Block", new ItemStack(Blocks.LAPIS_BLOCK), 32+(7*16), 32));
		manager.registerInfoPage("lapis_block", new GuideInfoPage("lapis_block", EnumPageType.INFO));
		resource.addEntry(new GuideEntry("diamond_block", "Block of Diamond", new ItemStack(Blocks.DIAMOND_BLOCK), 32+(8*16), 32));
		manager.registerInfoPage("diamond_block", new GuideInfoPage("diamond_block", EnumPageType.INFO));
		resource.addEntry(new GuideEntry("emerald_block", "Block of Emerald", new ItemStack(Blocks.EMERALD_BLOCK), 32+(9*16), 32));
		...
		misc_building.addEntry(new GuideEntry("lit_pumpkin", "Glow-Pumpkin", new ItemStack(Blocks.LIT_PUMPKIN), 32+(0*16), 32));
		manager.registerInfoPage("lit_pumpkin", new GuideInfoPage("lit_pumpkin", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("sea_lantern", "Sea Lantern", new ItemStack(Blocks.SEA_LANTERN), 32+(1*16), 32));
		manager.registerInfoPage("sea_lantern", new GuideInfoPage("sea_lantern", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("white_carpet", "White Carpet", new ItemStack(Blocks.CARPET, 1, 0), 32+(2*16), 32));
		manager.registerInfoPage("white_carpet", new GuideInfoPage("white_carpet", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("white_wool", "Wool", new ItemStack(Blocks.WOOL, 1, 0), 32+(3*16), 32));
		manager.registerInfoPage("white_wool", new GuideInfoPage("white_wool", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("light_gray_carpet", "Light Gray Carpet", new ItemStack(Blocks.CARPET, 1, 8), 32+(4*16), 32));
		manager.registerInfoPage("light_gray_carpet", new GuideInfoPage("light_gray_carpet", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("light_gray_wool", "Light Gray Wool", new ItemStack(Blocks.WOOL, 1, 8), 32+(5*16), 32));
		manager.registerInfoPage("light_gray_wool", new GuideInfoPage("light_gray_wool", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("gray_carpet", "Gray Carpet", new ItemStack(Blocks.CARPET, 1, 7), 32+(6*16), 32));
		manager.registerInfoPage("gray_carpet", new GuideInfoPage("gray_carpet", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("gray_wool", "Gray Wool", new ItemStack(Blocks.WOOL, 1, 7), 32+(7*16), 32));
		manager.registerInfoPage("gray_wool", new GuideInfoPage("gray_wool", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("black_carpet", "Black Carpet", new ItemStack(Blocks.CARPET, 1, 15), 32+(8*16), 32));
		manager.registerInfoPage("black_carpet", new GuideInfoPage("black_carpet", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("black_wool", "Black Wool", new ItemStack(Blocks.WOOL, 1, 15), 32+(9*16), 32));
		manager.registerInfoPage("black_wool", new GuideInfoPage("black_wool", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("brown_carpet", "Brown Carpet", new ItemStack(Blocks.CARPET, 1, 12), 32+(10*16), 32));
		manager.registerInfoPage("brown_carpet", new GuideInfoPage("brown_carpet", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("brown_wool", "Brown Wool", new ItemStack(Blocks.WOOL, 1, 12), 32+(11*16), 32));
		manager.registerInfoPage("brown_wool", new GuideInfoPage("brown_wool", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("red_carpet", "Red Carpet", new ItemStack(Blocks.CARPET, 1, 14), 32+(12*16), 32));
		manager.registerInfoPage("red_carpet", new GuideInfoPage("red_carpet", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("red_wool", "Red Wool", new ItemStack(Blocks.WOOL, 1, 14), 32+(13*16), 32));
		manager.registerInfoPage("red_wool", new GuideInfoPage("red_wool", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("orange_carpet", "Orange Carpet", new ItemStack(Blocks.CARPET, 1, 1), 32+(14*16), 32));
		manager.registerInfoPage("orange_carpet", new GuideInfoPage("orange_carpet", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("orange_wool", "Orange Wool", new ItemStack(Blocks.WOOL, 1, 1), 32+(15*16), 32));
		manager.registerInfoPage("orange_wool", new GuideInfoPage("orange_wool", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("yellow_carpet", "Yellow Carpet", new ItemStack(Blocks.CARPET, 1, 4), 32+(0*16), 58));
		manager.registerInfoPage("yellow_carpet", new GuideInfoPage("yellow_carpet", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("yellow_wool", "Yellow Wool", new ItemStack(Blocks.WOOL, 1, 4), 32+(1*16), 58));
		manager.registerInfoPage("yellow_wool", new GuideInfoPage("yellow_wool", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("lime_carpet", "Lime Carpet", new ItemStack(Blocks.CARPET, 1, 5), 32+(2*16), 58));
		manager.registerInfoPage("lime_carpet", new GuideInfoPage("lime_carpet", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("lime_wool", "Lime Wool", new ItemStack(Blocks.WOOL, 1, 5), 32+(3*16), 58));
		manager.registerInfoPage("lime_wool", new GuideInfoPage("lime_wool", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("green_carpet", "Green Carpet", new ItemStack(Blocks.CARPET, 1, 13), 32+(4*16), 58));
		manager.registerInfoPage("green_carpet", new GuideInfoPage("green_carpet", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("green_wool", "Green Wool", new ItemStack(Blocks.WOOL, 1, 13), 32+(5*16), 58));
		manager.registerInfoPage("green_wool", new GuideInfoPage("green_wool", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("cyan_carpet", "Cyan Carpet", new ItemStack(Blocks.CARPET, 1, 9), 32+(6*16), 58));
		manager.registerInfoPage("cyan_carpet", new GuideInfoPage("cyan_carpet", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("cyan_wool", "Cyan Wool", new ItemStack(Blocks.WOOL, 1, 9), 32+(7*16), 58));
		manager.registerInfoPage("cyan_wool", new GuideInfoPage("cyan_wool", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("light_blue_carpet", "Light Blue Carpet", new ItemStack(Blocks.CARPET, 1, 3), 32+(8*16), 58));
		manager.registerInfoPage("light_blue_carpet", new GuideInfoPage("light_blue_carpet", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("light_blue_wool", "Light Blue Wool", new ItemStack(Blocks.WOOL, 1, 3), 32+(9*16), 58));
		manager.registerInfoPage("light_blue_wool", new GuideInfoPage("light_blue_wool", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("blue_carpet", "Blue Carpet", new ItemStack(Blocks.CARPET, 1, 11), 32+(10*16), 58));
		manager.registerInfoPage("blue_carpet", new GuideInfoPage("blue_carpet", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("blue_wool", "Blue Wool", new ItemStack(Blocks.WOOL, 1, 11), 32+(11*16), 58));
		manager.registerInfoPage("blue_wool", new GuideInfoPage("blue_wool", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("purple_carpet", "Purple Carpet", new ItemStack(Blocks.CARPET, 1, 10), 32+(12*16), 58));
		manager.registerInfoPage("purple_carpet", new GuideInfoPage("purple_carpet", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("purple_wool", "Purple Wool", new ItemStack(Blocks.WOOL, 1, 10), 32+(13*16), 58));
		manager.registerInfoPage("purple_wool", new GuideInfoPage("purple_wool", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("magenta_carpet", "Magenta Carpet", new ItemStack(Blocks.CARPET, 1, 2), 32+(14*16), 58));
		manager.registerInfoPage("magenta_carpet", new GuideInfoPage("magenta_carpet", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("magenta_wool", "Magenta Wool", new ItemStack(Blocks.WOOL, 1, 2), 32+(15*16), 58));
		manager.registerInfoPage("magenta_wool", new GuideInfoPage("magenta_wool", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("pink_carpet", "Pink Carpet", new ItemStack(Blocks.CARPET, 1, 6), 32+(0*16), 84));
		manager.registerInfoPage("pink_carpet", new GuideInfoPage("pink_carpet", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("pink_wool", "Pink Wool", new ItemStack(Blocks.WOOL, 1, 6), 32+(1*16), 84));
		manager.registerInfoPage("pink_wool", new GuideInfoPage("pink_wool", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("white_stained_clay", "White Stained Clay", new ItemStack(Blocks.STAINED_HARDENED_CLAY, 1, 0), 32+(2*16), 84));
		manager.registerInfoPage("white_stained_clay", new GuideInfoPage("white_stained_clay", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("light_gray_stained_clay", "Light Gray Stained Clay", new ItemStack(Blocks.STAINED_HARDENED_CLAY, 1, 8), 32+(3*16), 84));
		manager.registerInfoPage("light_gray_stained_clay", new GuideInfoPage("light_gray_stained_clay", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("gray_stained_clay", "Gray Stained Clay", new ItemStack(Blocks.STAINED_HARDENED_CLAY, 1, 7), 32+(4*16), 84));
		manager.registerInfoPage("gray_stained_clay", new GuideInfoPage("gray_stained_clay", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("black_stained_clay", "Black Stained Clay", new ItemStack(Blocks.STAINED_HARDENED_CLAY, 1, 15), 32+(5*16), 84));
		manager.registerInfoPage("black_stained_clay", new GuideInfoPage("black_stained_clay", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("brown_stained_clay", "Brown Stained Clay", new ItemStack(Blocks.STAINED_HARDENED_CLAY, 1, 12), 32+(6*16), 84));
		manager.registerInfoPage("brown_stained_clay", new GuideInfoPage("brown_stained_clay", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("red_stained_clay", "Red Stained Clay", new ItemStack(Blocks.STAINED_HARDENED_CLAY, 1, 14), 32+(7*16), 84));
		manager.registerInfoPage("red_stained_clay", new GuideInfoPage("red_stained_clay", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("orange_stained_clay", "Orange Stained Clay", new ItemStack(Blocks.STAINED_HARDENED_CLAY, 1, 1), 32+(8*16), 84));
		manager.registerInfoPage("orange_stained_clay", new GuideInfoPage("orange_stained_clay", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("yellow_stained_clay", "Yellow Stained Clay", new ItemStack(Blocks.STAINED_HARDENED_CLAY, 1, 4), 32+(9*16), 84));
		manager.registerInfoPage("yellow_stained_clay", new GuideInfoPage("yellow_stained_clay", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("lime_stained_clay", "Lime Stained Clay", new ItemStack(Blocks.STAINED_HARDENED_CLAY, 1, 5), 32+(10*16), 84));
		manager.registerInfoPage("lime_stained_clay", new GuideInfoPage("lime_stained_clay", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("green_stained_clay", "Green Stained Clay", new ItemStack(Blocks.STAINED_HARDENED_CLAY, 1, 13), 32+(11*16), 84));
		manager.registerInfoPage("green_stained_clay", new GuideInfoPage("green_stained_clay", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("cyan_stained_clay", "Cyan Stained Clay", new ItemStack(Blocks.STAINED_HARDENED_CLAY, 1, 9), 32+(12*16), 84));
		manager.registerInfoPage("cyan_stained_clay", new GuideInfoPage("cyan_stained_clay", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("light_blue_stained_clay", "Light Blue Stained Clay", new ItemStack(Blocks.STAINED_HARDENED_CLAY, 1, 3), 32+(13*16), 84));
		manager.registerInfoPage("light_blue_stained_clay", new GuideInfoPage("light_blue_stained_clay", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("blue_stained_clay", "Blue Stained Clay", new ItemStack(Blocks.STAINED_HARDENED_CLAY, 1, 11), 32+(14*16), 84));
		manager.registerInfoPage("blue_stained_clay", new GuideInfoPage("blue_stained_clay", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("purple_stained_clay", "Purple Stained Clay", new ItemStack(Blocks.STAINED_HARDENED_CLAY, 1, 10), 32+(15*16), 84));
		manager.registerInfoPage("purple_stained_clay", new GuideInfoPage("purple_stained_clay", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("magenta_stained_clay", "Magenta Stained Clay", new ItemStack(Blocks.STAINED_HARDENED_CLAY, 1, 2), 32+(0*16), 110));
		manager.registerInfoPage("magenta_stained_clay", new GuideInfoPage("magenta_stained_clay", EnumPageType.INFO));
		misc_building.addEntry(new GuideEntry("pink_stained_clay", "Pink Stained Clay", new ItemStack(Blocks.STAINED_HARDENED_CLAY, 1, 6), 32+(1*16), 110));
		...
		stone_building.addEntry(new GuideEntry("smooth_red_sandstone", "Polished Red Sandstone", new ItemStack(Blocks.RED_SANDSTONE, 0, 2), 32+(4*16), 58));
		manager.registerInfoPage("smooth_red_sandstone", new GuideInfoPage("smooth_red_sandstone", EnumPageType.INFO));
		stone_building.addEntry(new GuideEntry("chiseled_red_sandstone", "Chiseled Red Sandstone", new ItemStack(Blocks.RED_SANDSTONE, 0, 1), 32+(5*16), 58));
		manager.registerInfoPage("chiseled_red_sandstone", new GuideInfoPage("chiseled_red_sandstone", EnumPageType.INFO));
		stone_building.addEntry(new GuideEntry("brick_slab", "Clay Brick Slab", new ItemStack(Blocks.STONE_SLAB, 1, 4), 32+(6*16), 58));
		manager.registerInfoPage("brick_slab", new GuideInfoPage("brick_slab", EnumPageType.INFO));
		stone_building.addEntry(new GuideEntry("brick_stairs", "Clay Brick Stairs", new ItemStack(Blocks.BRICK_STAIRS), 32+(7*16), 58));
		manager.registerInfoPage("brick_stairs", new GuideInfoPage("brick_stairs", EnumPageType.INFO));
		stone_building.addEntry(new GuideEntry("brick_block", "Clay Bricks", new ItemStack(Blocks.BRICK_BLOCK), 32+(8*16), 58));
		manager.registerInfoPage("brick_block", new GuideInfoPage("brick_block", EnumPageType.INFO));
		stone_building.addEntry(new GuideEntry("prismarine_bricks", "Prismarine Bricks", new ItemStack(Blocks.PRISMARINE, 0, 1), 32+(9*16), 58));
		manager.registerInfoPage("prismarine_bricks", new GuideInfoPage("prismarine_bricks", EnumPageType.INFO));
		stone_building.addEntry(new GuideEntry("prismarine_dark", "Dark Prismarine Tiles", new ItemStack(Blocks.PRISMARINE, 0, 2), 32+(10*16), 58));
		manager.registerInfoPage("prismarine_dark", new GuideInfoPage("prismarine_dark", EnumPageType.INFO));
		stone_building.addEntry(new GuideEntry("nether_brick_slab", "Nether Brick Slab", new ItemStack(Blocks.STONE_SLAB, 1, 6), 32+(11*16), 58));
		manager.registerInfoPage("nether_brick_slab", new GuideInfoPage("nether_brick_slab", EnumPageType.INFO));
		stone_building.addEntry(new GuideEntry("nether_brick_stairs", "Nether Brick Stairs", new ItemStack(Blocks.NETHER_BRICK_STAIRS), 32+(12*16), 58));
		...
		stone_building.addEntry(new GuideEntry("quartz_stairs", "Nether Quartz Stairs", new ItemStack(Blocks.QUARTZ_STAIRS), 32+(0*16), 84));
		manager.registerInfoPage("quartz_stairs", new GuideInfoPage("quartz_stairs", EnumPageType.INFO));
		stone_building.addEntry(new GuideEntry("quartz_block", "Block of Nether Quartz", new ItemStack(Blocks.QUARTZ_BLOCK, 0, 0), 32+(1*16), 84));
		manager.registerInfoPage("quartz_block", new GuideInfoPage("quartz_block", EnumPageType.INFO));
		stone_building.addEntry(new GuideEntry("chiseled_quartz_block", "Chiseled Nether Quartz", new ItemStack(Blocks.QUARTZ_BLOCK, 0, 1), 32+(2*16), 84));
		manager.registerInfoPage("chiseled_quartz_block", new GuideInfoPage("chiseled_quartz_block", EnumPageType.INFO));
		stone_building.addEntry(new GuideEntry("quartz_pillar", "Nether Quartz Pillar", new ItemStack(Blocks.QUARTZ_BLOCK, 0, 2), 32+(3*16), 84));
		manager.registerInfoPage("quartz_pillar", new GuideInfoPage("quartz_pillar", EnumPageType.INFO));
		stone_building.addEntry(new GuideEntry("end_stone_bricks", "End Stone Bricks", new ItemStack(Blocks.END_BRICKS), 32+(4*16), 84));
		manager.registerInfoPage("end_stone_bricks", new GuideInfoPage("end_stone_bricks", EnumPageType.INFO));
		stone_building.addEntry(new GuideEntry("purpur_slab", "Purpur Tile Slab", new ItemStack(Blocks.PURPUR_SLAB, 1, 0), 32+(5*16), 84));
		manager.registerInfoPage("purpur_slab", new GuideInfoPage("purpur_slab", EnumPageType.INFO));
		stone_building.addEntry(new GuideEntry("purpur_stairs", "Purpur Tile Stairs", new ItemStack(Blocks.PURPUR_STAIRS), 32+(6*16), 84));
		manager.registerInfoPage("purpur_stairs", new GuideInfoPage("purpur_stairs", EnumPageType.INFO));
		stone_building.addEntry(new GuideEntry("purpur_block", "Purpur Tiles", new ItemStack(Blocks.PURPUR_BLOCK), 32+(7*16), 84));
		manager.registerInfoPage("purpur_block", new GuideInfoPage("purpur_block", EnumPageType.INFO));
		stone_building.addEntry(new GuideEntry("purpur_pillar", "Purpur Pillar", new ItemStack(Blocks.PURPUR_PILLAR), 32+(8*16), 84));
		manager.registerInfoPage("purpur_pillar", new GuideInfoPage("purpur_pillar", EnumPageType.INFO));
		...
		decor.addEntry(new GuideEntry("end_rod", "End Rod", new ItemStack(Blocks.END_ROD), 32+(1*16), 32));
		manager.registerInfoPage("end_rod", new GuideInfoPage("end_rod", EnumPageType.INFO));
		...
		decor.addEntry(new GuideEntry("banner", "Banner", new ItemStack(Items.BANNER), 32+(3*16), 32));
		manager.registerInfoPage("banner", new GuideInfoPage("banner", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("sign", "Sign", new ItemStack(Items.SIGN), 32+(4*16), 32));
		manager.registerInfoPage("sign", new GuideInfoPage("sign", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("painting", "Painting", new ItemStack(Items.PAINTING), 32+(5*16), 32));
		manager.registerInfoPage("painting", new GuideInfoPage("painting", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("glass_pane", "Glass Pane", new ItemStack(Blocks.GLASS_PANE), 32+(6*16), 32));
		manager.registerInfoPage("glass_pane", new GuideInfoPage("glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("white_stained_glass_pane", "White Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 0), 32+(7*16), 32));
		manager.registerInfoPage("white_stained_glass_pane", new GuideInfoPage("white_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("light_gray_stained_glass_pane", "Light Gray Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 8), 32+(8*16), 32));
		manager.registerInfoPage("light_gray_stained_glass_pane", new GuideInfoPage("light_gray_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("gray_stained_glass_pane", "Gray Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 7), 32+(9*16), 32));
		manager.registerInfoPage("gray_stained_glass_pane", new GuideInfoPage("gray_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("black_stained_glass_pane", "Black Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 15), 32+(10*16), 32));
		manager.registerInfoPage("black_stained_glass_pane", new GuideInfoPage("black_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("brown_stained_glass_pane", "Brown Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 12), 32+(11*16), 32));
		manager.registerInfoPage("brown_stained_glass_pane", new GuideInfoPage("brown_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("red_stained_glass_pane", "Red Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 14), 32+(12*16), 32));
		manager.registerInfoPage("red_stained_glass_pane", new GuideInfoPage("red_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("orange_stained_glass_pane", "Orange Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 1), 32+(13*16), 32));
		manager.registerInfoPage("orange_stained_glass_pane", new GuideInfoPage("orange_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("yellow_stained_glass_pane", "Yellow Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 4), 32+(14*16), 32));
		manager.registerInfoPage("yellow_stained_glass_pane", new GuideInfoPage("yellow_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("lime_stained_glass_pane", "Lime Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 5), 32+(15*16), 32));
		manager.registerInfoPage("lime_stained_glass_pane", new GuideInfoPage("lime_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("green_stained_glass_pane", "Green Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 13), 32+(0*16), 58));
		manager.registerInfoPage("green_stained_glass_pane", new GuideInfoPage("green_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("cyan_stained_glass_pane", "Cyan Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 9), 32+(1*16), 58));
		manager.registerInfoPage("cyan_stained_glass_pane", new GuideInfoPage("cyan_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("light_blue_stained_glass_pane", "Light Blue Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 3), 32+(2*16), 58));
		manager.registerInfoPage("light_blue_stained_glass_pane", new GuideInfoPage("light_blue_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("blue_stained_glass_pane", "Blue Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 11), 32+(3*16), 58));
		manager.registerInfoPage("blue_stained_glass_pane", new GuideInfoPage("blue_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("purple_stained_glass_pane", "Purple Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 10), 32+(4*16), 58));
		manager.registerInfoPage("purple_stained_glass_pane", new GuideInfoPage("purple_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("magenta_stained_glass_pane", "Magenta Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 2), 32+(5*16), 58));
		manager.registerInfoPage("magenta_stained_glass_pane", new GuideInfoPage("magenta_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("pink_stained_glass_pane", "Pink Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 6), 32+(6*16), 58));
		manager.registerInfoPage("pink_stained_glass_pane", new GuideInfoPage("pink_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("iron_bars", "Iron Bars", new ItemStack(Blocks.IRON_BARS), 32+(7*16), 58));
		manager.registerInfoPage("iron_bars", new GuideInfoPage("iron_bars", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("oak_fence", "Oak Plank Fence", new ItemStack(Blocks.OAK_FENCE), 32+(8*16), 58));
		manager.registerInfoPage("oak_fence", new GuideInfoPage("oak_fence", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("spruce_fence", "Spruce Plank Fence", new ItemStack(Blocks.SPRUCE_FENCE), 32+(9*16), 58));
		manager.registerInfoPage("spruce_fence", new GuideInfoPage("spruce_fence", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("birch_fence", "Birch Plank Fence", new ItemStack(Blocks.BIRCH_FENCE), 32+(10*16), 58));
		manager.registerInfoPage("birch_fence", new GuideInfoPage("birch_fence", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("jungle_fence", "Jungle Plank Fence", new ItemStack(Blocks.JUNGLE_FENCE), 32+(11*16), 58));
		manager.registerInfoPage("jungle_fence", new GuideInfoPage("jungle_fence", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("acacia_fence", "Acacia Plank Fence", new ItemStack(Blocks.ACACIA_FENCE), 32+(12*16), 58));
		manager.registerInfoPage("acacia_fence", new GuideInfoPage("acacia_fence", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("dark_oak_fence", "Dark Oak Plank Fence", new ItemStack(Blocks.DARK_OAK_FENCE), 32+(13*16), 58));
		manager.registerInfoPage("dark_oak_fence", new GuideInfoPage("dark_oak_fence", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("nether_brick_fence", "Nether Brick Fence", new ItemStack(Blocks.NETHER_BRICK_FENCE), 32+(14*16), 58));
		manager.registerInfoPage("nether_brick_fence", new GuideInfoPage("nether_brick_fence", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("cobblestone_wall", "Cobblestone Wall", new ItemStack(Blocks.COBBLESTONE_WALL, 0, 0), 32+(15*16), 58));
		manager.registerInfoPage("cobblestone_wall", new GuideInfoPage("cobblestone_wall", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("mossy_cobblestone_wall", "Mossy Cobblestone Wall", new ItemStack(Blocks.COBBLESTONE_WALL, 0, 1), 32+(0*16), 84));
		manager.registerInfoPage("mossy_cobblestone_wall", new GuideInfoPage("mossy_cobblestone_wall", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("oak_fence_gate", "Oak Plank Fence Gate", new ItemStack(Blocks.OAK_FENCE_GATE), 32+(1*16), 84));
		manager.registerInfoPage("oak_fence_gate", new GuideInfoPage("oak_fence_gate", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("spruce_fence_gate", "Spruce Plank Fence Gate", new ItemStack(Blocks.SPRUCE_FENCE_GATE), 32+(2*16), 84));
		manager.registerInfoPage("spruce_fence_gate", new GuideInfoPage("spruce_fence_gate", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("birch_fence_gate", "Birch Plank Fence Gate", new ItemStack(Blocks.BIRCH_FENCE_GATE), 32+(3*16), 84));
		manager.registerInfoPage("birch_fence_gate", new GuideInfoPage("birch_fence_gate", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("jungle_fence_gate", "Jungle Plank Fence Gate", new ItemStack(Blocks.JUNGLE_FENCE_GATE), 32+(4*16), 84));
		manager.registerInfoPage("jungle_fence_gate", new GuideInfoPage("jungle_fence_gate", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("acacia_fence_gate", "Acacia Plank Fence Gate", new ItemStack(Blocks.ACACIA_FENCE_GATE), 32+(5*16), 84));
		manager.registerInfoPage("acacia_fence_gate", new GuideInfoPage("acacia_fence_gate", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("dark_oak_fence_gate", "Dark Oak Plank Fence Gate", new ItemStack(Blocks.DARK_OAK_FENCE_GATE), 32+(6*16), 84));
		manager.registerInfoPage("dark_oak_fence_gate", new GuideInfoPage("dark_oak_fence_gate", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("trapdoor", "Wooden Trapdoor", new ItemStack(Blocks.TRAPDOOR), 32+(7*16), 84));
		manager.registerInfoPage("trapdoor", new GuideInfoPage("trapdoor", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("iron_trapdoor", "Iron Trapdoor", new ItemStack(Blocks.IRON_TRAPDOOR), 32+(8*16), 84));
		manager.registerInfoPage("iron_trapdoor", new GuideInfoPage("iron_trapdoor", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("oak_door", "Oak Door", new ItemStack(Items.OAK_DOOR), 32+(9*16), 84));
		manager.registerInfoPage("oak_door", new GuideInfoPage("oak_door", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("spruce_door", "Spruce Door", new ItemStack(Items.SPRUCE_DOOR), 32+(10*16), 84));
		manager.registerInfoPage("spruce_door", new GuideInfoPage("spruce_door", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("birch_door", "Birch Door", new ItemStack(Items.BIRCH_DOOR), 32+(11*16), 84));
		manager.registerInfoPage("birch_door", new GuideInfoPage("birch_door", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("jungle_door", "Jungle Door", new ItemStack(Items.JUNGLE_DOOR), 32+(12*16), 84));
		manager.registerInfoPage("jungle_door", new GuideInfoPage("jungle_door", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("acacia_door", "Acacia Door", new ItemStack(Items.ACACIA_DOOR), 32+(13*16), 84));
		manager.registerInfoPage("acacia_door", new GuideInfoPage("acacia_door", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("dark_oak_door", "Dark Oak Door", new ItemStack(Items.DARK_OAK_DOOR), 32+(14*16), 84));
		manager.registerInfoPage("dark_oak_door", new GuideInfoPage("dark_oak_door", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("iron_door", "Iron Door", new ItemStack(Items.IRON_DOOR), 32+(15*16), 84));
		manager.registerInfoPage("iron_door", new GuideInfoPage("iron_door", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("skull_player", "Human Head", new ItemStack(Items.SKULL, 0, 3), 32+(0*16), 84));
		manager.registerInfoPage("skull_player", new GuideInfoPage("skull_player", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("skull_zombie", "Zombie Head", new ItemStack(Items.SKULL, 0, 2), 32+(1*16), 110));
		manager.registerInfoPage("skull_zombie", new GuideInfoPage("skull_zombie", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("skull_skeleton", "Skeleton Skull", new ItemStack(Items.SKULL, 0, 0), 32+(2*16), 110));
		manager.registerInfoPage("skull_skeleton", new GuideInfoPage("skull_skeleton", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("skull_wither_skeleton", "Wither Skeleton Skull", new ItemStack(Items.SKULL, 0, 1), 32+(3*16), 110));
		manager.registerInfoPage("skull_wither_skeleton", new GuideInfoPage("skull_wither_skeleton", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("skull_creeper", "Creeper Head", new ItemStack(Items.SKULL, 0, 4), 32+(4*16), 110));
		manager.registerInfoPage("skull_creeper", new GuideInfoPage("skull_creeper", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("skull_dragon", "Dragon Head", new ItemStack(Items.SKULL, 0, 5), 32+(5*16), 110));
		manager.registerInfoPage("skull_dragon", new GuideInfoPage("skull_dragon", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("dragon_egg", "Dragon Egg", new ItemStack(Blocks.DRAGON_EGG), 32+(6*16), 110));
		...
		crops.addEntry(new GuideEntry("wheat_seeds", "Wheat Seeds", new ItemStack(Items.WHEAT_SEEDS), 32+(0*16), 32));
		manager.registerInfoPage("wheat_seeds", new GuideInfoPage("wheat_seeds", EnumPageType.INFO));
		crops.addEntry(new GuideEntry("wheat", "Wheat", new ItemStack(Items.WHEAT), 32+(1*16), 32));
		manager.registerInfoPage("wheat", new GuideInfoPage("wheat", EnumPageType.INFO));
		
		materials.addEntry(new GuideEntry("snowball", "Snowball", new ItemStack(Items.SNOWBALL), 32+(0*16), 32));
		manager.registerInfoPage("snowball", new GuideInfoPage("snowball", EnumPageType.INFO));
		materials.addEntry(new GuideEntry("coal", "Coal", new ItemStack(Items.COAL, 0, 0), 32+(1*16), 32));
		manager.registerInfoPage("coal", new GuideInfoPage("coal", EnumPageType.INFO));
		materials.addEntry(new GuideEntry("charcoal", "Charcoal", new ItemStack(Items.COAL, 0, 1), 32+(2*16), 32));
		manager.registerInfoPage("charcoal", new GuideInfoPage("charcoal", EnumPageType.INFO));
		materials.addEntry(new GuideEntry("gunpowder", "Gunpowder", new ItemStack(Items.GUNPOWDER), 32+(3*16), 32));
		manager.registerInfoPage("gunpowder", new GuideInfoPage("gunpowder", EnumPageType.INFO));
		materials.addEntry(new GuideEntry("flint", "Flint", new ItemStack(Items.FLINT), 32+(4*16), 32));
		manager.registerInfoPage("flint", new GuideInfoPage("flint", EnumPageType.INFO));
		materials.addEntry(new GuideEntry("iron_ingot", "Iron Ingot", new ItemStack(Items.IRON_INGOT), 32+(5*16), 32));
		manager.registerInfoPage("iron_ingot", new GuideInfoPage("iron_ingot", EnumPageType.INFO));
		materials.addEntry(new GuideEntry("gold_ingot", "Gold Ingot", new ItemStack(Items.GOLD_INGOT), 32+(6*16), 32));
		manager.registerInfoPage("gold_ingot", new GuideInfoPage("gold_ingot", EnumPageType.INFO));
		materials.addEntry(new GuideEntry("diamond", "Diamond", new ItemStack(Items.DIAMOND), 32+(7*16), 32));
		manager.registerInfoPage("diamond", new GuideInfoPage("diamond", EnumPageType.INFO));
		
		mob_loot.addEntry(new GuideEntry("feather", "Feather", new ItemStack(Items.FEATHER), 32+(0*16), 32));
		manager.registerInfoPage("feather", new GuideInfoPage("feather", EnumPageType.INFO));
		mob_loot.addEntry(new GuideEntry("string", "String", new ItemStack(Items.STRING), 32+(1*16), 32));
		manager.registerInfoPage("string", new GuideInfoPage("string", EnumPageType.INFO));
		
		ingredients.addEntry(new GuideEntry("stick", "Stick", new ItemStack(Items.STICK), 32+(0*16), 32));
		manager.registerInfoPage("stick", new GuideInfoPage("stick", EnumPageType.INFO));
		ingredients.addEntry(new GuideEntry("bowl", "Wooden Bowl", new ItemStack(Items.BOWL), 32+(1*16), 32));
		manager.registerInfoPage("bowl", new GuideInfoPage("bowl", EnumPageType.INFO));
		
		food.addEntry(new GuideEntry("apple", "Apple", new ItemStack(Items.APPLE), 32+(0*16), 32));
		manager.registerInfoPage("apple", new GuideInfoPage("apple", EnumPageType.INFO));
		food.addEntry(new GuideEntry("golden_apple", "Golden Apple", new ItemStack(Items.GOLDEN_APPLE, 0, 0), 32+(1*16), 32));
		manager.registerInfoPage("golden_apple", new GuideInfoPage("golden_apple", EnumPageType.INFO));
		food.addEntry(new GuideEntry("notch_apple", "Notch Apple", new ItemStack(Items.GOLDEN_APPLE, 0, 1), 32+(2*16), 32));
		manager.registerInfoPage("notch_apple", new GuideInfoPage("notch_apple", EnumPageType.INFO));
		food.addEntry(new GuideEntry("bread", "Bread", new ItemStack(Items.BREAD), 32+(3*16), 32));
		manager.registerInfoPage("bread", new GuideInfoPage("bread", EnumPageType.INFO));
		food.addEntry(new GuideEntry("cake", "Cake", new ItemStack(Items.CAKE), 32+(4*16), 32));
		manager.registerInfoPage("cake", new GuideInfoPage("cake", EnumPageType.INFO));
		food.addEntry(new GuideEntry("raw_porkchop", "Raw Porkchop", new ItemStack(Items.PORKCHOP), 32+(5*16), 32));
		manager.registerInfoPage("raw_porkchop", new GuideInfoPage("raw_porkchop", EnumPageType.INFO));
		food.addEntry(new GuideEntry("cooked_porkchop", "Cooked Porkchop", new ItemStack(Items.COOKED_PORKCHOP), 32+(6*16), 32));
		manager.registerInfoPage("cooked_porkchop", new GuideInfoPage("cooked_porkchop", EnumPageType.INFO));
		food.addEntry(new GuideEntry("mushroom_stew", "Mushroom Stew", new ItemStack(Items.MUSHROOM_STEW), 32+(7*16), 32));
		manager.registerInfoPage("mushroom_stew", new GuideInfoPage("mushroom_stew", EnumPageType.INFO));
		
		
		transport.addEntry(new GuideEntry("saddle", "Saddle", new ItemStack(Items.SADDLE), 32+(0*16), 32));
		manager.registerInfoPage("saddle", new GuideInfoPage("saddle", EnumPageType.INFO));
		transport.addEntry(new GuideEntry("minecart", "Minecart", new ItemStack(Items.MINECART), 32+(1*16), 32));
		manager.registerInfoPage("minecart", new GuideInfoPage("minecart", EnumPageType.INFO));
		
		tool.addEntry(new GuideEntry("gold_pickaxe", "Golden Pickaxe", new ItemStack(Items.GOLDEN_PICKAXE), 32+(0*16), 32));
		manager.registerInfoPage("gold_pickaxe", new GuideInfoPage("gold_pickaxe", EnumPageType.INFO));
		tool.addEntry(new GuideEntry("gold_axe", "Golden Axe", new ItemStack(Items.GOLDEN_AXE), 32+(1*16), 32));
		manager.registerInfoPage("gold_axe", new GuideInfoPage("gold_axe", EnumPageType.INFO));
		tool.addEntry(new GuideEntry("gold_shovel", "Golden Shovel", new ItemStack(Items.GOLDEN_SHOVEL), 32+(2*16), 32));
		manager.registerInfoPage("gold_shovel", new GuideInfoPage("gold_shovel", EnumPageType.INFO));
		tool.addEntry(new GuideEntry("gold_hoe", "Golden Hoe", new ItemStack(Items.GOLDEN_HOE), 32+(3*16), 32));
		manager.registerInfoPage("gold_hoe", new GuideInfoPage("gold_hoe", EnumPageType.INFO));
		tool.addEntry(new GuideEntry("wood_pickaxe", "Wooden Pickaxe", new ItemStack(Items.WOODEN_PICKAXE), 32+(4*16), 32));
		manager.registerInfoPage("wood_pickaxe", new GuideInfoPage("wood_pickaxe", EnumPageType.INFO));
		tool.addEntry(new GuideEntry("wood_axe", "Wooden Axe", new ItemStack(Items.WOODEN_AXE), 32+(5*16), 32));
		manager.registerInfoPage("wood_axe", new GuideInfoPage("wood_axe", EnumPageType.INFO));
		tool.addEntry(new GuideEntry("wood_shovel", "Wooden Shovel", new ItemStack(Items.WOODEN_SHOVEL), 32+(6*16), 32));
		manager.registerInfoPage("wood_shovel", new GuideInfoPage("wood_shovel", EnumPageType.INFO));
		tool.addEntry(new GuideEntry("wood_hoe", "Wooden Hoe", new ItemStack(Items.WOODEN_HOE), 32+(7*16), 32));
		manager.registerInfoPage("wood_hoe", new GuideInfoPage("wood_hoe", EnumPageType.INFO));
		tool.addEntry(new GuideEntry("stone_pickaxe", "Stone Pickaxe", new ItemStack(Items.STONE_PICKAXE), 32+(8*16), 32));
		manager.registerInfoPage("stone_pickaxe", new GuideInfoPage("stone_pickaxe", EnumPageType.INFO));
		tool.addEntry(new GuideEntry("stone_axe", "Stone Axe", new ItemStack(Items.STONE_AXE), 32+(9*16), 32));
		manager.registerInfoPage("stone_axe", new GuideInfoPage("stone_axe", EnumPageType.INFO));
		tool.addEntry(new GuideEntry("stone_shovel", "Stone Shovel", new ItemStack(Items.STONE_SHOVEL), 32+(10*16), 32));
		manager.registerInfoPage("stone_shovel", new GuideInfoPage("stone_shovel", EnumPageType.INFO));
		tool.addEntry(new GuideEntry("stone_hoe", "Stone Hoe", new ItemStack(Items.STONE_HOE), 32+(11*16), 32));
		manager.registerInfoPage("stone_hoe", new GuideInfoPage("stone_hoe", EnumPageType.INFO));
		tool.addEntry(new GuideEntry("iron_pickaxe", "Iron Pickaxe", new ItemStack(Items.IRON_PICKAXE), 32+(12*16), 32));
		manager.registerInfoPage("iron_pickaxe", new GuideInfoPage("iron_pickaxe", EnumPageType.INFO));
		tool.addEntry(new GuideEntry("iron_axe", "Iron Axe", new ItemStack(Items.IRON_AXE), 32+(13*16), 32));
		manager.registerInfoPage("iron_axe", new GuideInfoPage("iron_axe", EnumPageType.INFO));
		tool.addEntry(new GuideEntry("iron_shovel", "Iron Shovel", new ItemStack(Items.IRON_SHOVEL), 32+(14*16), 32));
		manager.registerInfoPage("iron_shovel", new GuideInfoPage("iron_shovel", EnumPageType.INFO));
		tool.addEntry(new GuideEntry("iron_hoe", "Iron Hoe", new ItemStack(Items.IRON_HOE), 32+(15*16), 32));
		manager.registerInfoPage("iron_hoe", new GuideInfoPage("iron_hoe", EnumPageType.INFO));
		tool.addEntry(new GuideEntry("diamond_pickaxe", "Diamond Pickaxe", new ItemStack(Items.DIAMOND_PICKAXE), 32+(0*16), 58));
		manager.registerInfoPage("diamond_pickaxe", new GuideInfoPage("diamond_pickaxe", EnumPageType.INFO));
		tool.addEntry(new GuideEntry("diamond_axe", "Diamond Axe", new ItemStack(Items.DIAMOND_AXE), 32+(1*16), 58));
		manager.registerInfoPage("diamond_axe", new GuideInfoPage("diamond_axe", EnumPageType.INFO));
		tool.addEntry(new GuideEntry("diamond_shovel", "Diamond Shovel", new ItemStack(Items.DIAMOND_SHOVEL), 32+(2*16), 58));
		manager.registerInfoPage("diamond_shovel", new GuideInfoPage("diamond_shovel", EnumPageType.INFO));
		tool.addEntry(new GuideEntry("diamond_hoe", "Diamond Hoe", new ItemStack(Items.DIAMOND_HOE), 32+(3*16), 58));
		manager.registerInfoPage("diamond_hoe", new GuideInfoPage("diamond_hoe", EnumPageType.INFO));
		
		special_tool.addEntry(new GuideEntry("bucket", "Bucket", new ItemStack(Items.BUCKET), 32+(0*16), 32));
		manager.registerInfoPage("bucket", new GuideInfoPage("bucket", EnumPageType.INFO));
		special_tool.addEntry(new GuideEntry("water_bucket", "Water Bucket", new ItemStack(Items.WATER_BUCKET), 32+(1*16), 32));
		manager.registerInfoPage("water_bucket", new GuideInfoPage("water_bucket", EnumPageType.INFO));
		special_tool.addEntry(new GuideEntry("lava_bucket", "Lava Bucket", new ItemStack(Items.LAVA_BUCKET), 32+(2*16), 32));
		manager.registerInfoPage("lava_bucket", new GuideInfoPage("lava_bucket", EnumPageType.INFO));
		special_tool.addEntry(new GuideEntry("flint_and_steel", "Flint and Steel", new ItemStack(Items.FLINT_AND_STEEL), 32+(3*16), 32));
		manager.registerInfoPage("flint_and_steel", new GuideInfoPage("flint_and_steel", EnumPageType.INFO));
		
		weapon.addEntry(new GuideEntry("gold_sword", "Golden Sword", new ItemStack(Items.GOLDEN_SWORD), 32+(0*16), 32));
		manager.registerInfoPage("gold_sword", new GuideInfoPage("gold_sword", EnumPageType.INFO));
		weapon.addEntry(new GuideEntry("wood_sword", "Wooden Sword", new ItemStack(Items.WOODEN_SWORD), 32+(1*16), 32));
		manager.registerInfoPage("wood_sword", new GuideInfoPage("wood_sword", EnumPageType.INFO));
		weapon.addEntry(new GuideEntry("stone_sword", "Stone Sword", new ItemStack(Items.STONE_SWORD), 32+(2*16), 32));
		manager.registerInfoPage("stone_sword", new GuideInfoPage("stone_sword", EnumPageType.INFO));
		weapon.addEntry(new GuideEntry("iron_sword", "Iron Sword", new ItemStack(Items.IRON_SWORD), 32+(3*16), 32));
		manager.registerInfoPage("iron_sword", new GuideInfoPage("iron_sword", EnumPageType.INFO));
		weapon.addEntry(new GuideEntry("diamond_sword", "Diamond Sword", new ItemStack(Items.DIAMOND_SWORD), 32+(4*16), 32));
		manager.registerInfoPage("diamond_sword", new GuideInfoPage("diamond_sword", EnumPageType.INFO));
		
		special_weapon.addEntry(new GuideEntry("bow", "Wooden Bow", new ItemStack(Items.BOW), 32+(0*16), 32));
		manager.registerInfoPage("bow", new GuideInfoPage("bow", EnumPageType.INFO));
		special_weapon.addEntry(new GuideEntry("arrow", "Arrow", new ItemStack(Items.ARROW), 32+(1*16), 32));
		manager.registerInfoPage("arrow", new GuideInfoPage("arrow", EnumPageType.INFO));
		special_weapon.addEntry(new GuideEntry("spectral_arrow", "Spectral Arrow", new ItemStack(Items.SPECTRAL_ARROW), 32+(2*16), 32));
		manager.registerInfoPage("spectral_arrow", new GuideInfoPage("spectral_arrow", EnumPageType.INFO));
		special_weapon.addEntry(new GuideEntry("tipped_arrow", "Tipped Arrow", new ItemStack(Items.TIPPED_ARROW), 32+(3*16), 32));
		manager.registerInfoPage("tipped_arrow", new GuideInfoPage("tipped_arrow", EnumPageType.INFO));
		
		armor.addEntry(new GuideEntry("leather_helmet", "Leather Helmet", new ItemStack(Items.LEATHER_HELMET), 32+(0*16), 32));
		manager.registerInfoPage("leather_helmet", new GuideInfoPage("leather_helmet", EnumPageType.INFO));
		armor.addEntry(new GuideEntry("leather_chestplate", "Leather Chestplate", new ItemStack(Items.LEATHER_CHESTPLATE), 32+(1*16), 32));
		manager.registerInfoPage("leather_chestplate", new GuideInfoPage("leather_chestplate", EnumPageType.INFO));
		armor.addEntry(new GuideEntry("leather_leggings", "Leather Leggings", new ItemStack(Items.LEATHER_LEGGINGS), 32+(2*16), 32));
		manager.registerInfoPage("leather_leggings", new GuideInfoPage("leather_leggings", EnumPageType.INFO));
		armor.addEntry(new GuideEntry("leather_boots", "Leather Boots", new ItemStack(Items.LEATHER_BOOTS), 32+(3*16), 32));
		manager.registerInfoPage("leather_boots", new GuideInfoPage("leather_boots", EnumPageType.INFO));
		armor.addEntry(new GuideEntry("gold_helmet", "Golden Helmet", new ItemStack(Items.GOLDEN_HELMET), 32+(4*16), 32));
		manager.registerInfoPage("gold_helmet", new GuideInfoPage("gold_helmet", EnumPageType.INFO));
		armor.addEntry(new GuideEntry("gold_chestplate", "Golden Chestplate", new ItemStack(Items.GOLDEN_CHESTPLATE), 32+(5*16), 32));
		manager.registerInfoPage("gold_chestplate", new GuideInfoPage("gold_chestplate", EnumPageType.INFO));
		armor.addEntry(new GuideEntry("gold_leggings", "Golden Leggings", new ItemStack(Items.GOLDEN_LEGGINGS), 32+(6*16), 32));
		manager.registerInfoPage("gold_leggings", new GuideInfoPage("gold_leggings", EnumPageType.INFO));
		armor.addEntry(new GuideEntry("gold_boots", "Golden Boots", new ItemStack(Items.GOLDEN_BOOTS), 32+(7*16), 32));
		manager.registerInfoPage("gold_boots", new GuideInfoPage("gold_boots", EnumPageType.INFO));
		armor.addEntry(new GuideEntry("chain_helmet", "Chain Helmet", new ItemStack(Items.CHAINMAIL_HELMET), 32+(8*16), 32));
		manager.registerInfoPage("chain_helmet", new GuideInfoPage("chain_helmet", EnumPageType.INFO));
		armor.addEntry(new GuideEntry("chain_chestplate", "Chain Chestplate", new ItemStack(Items.CHAINMAIL_CHESTPLATE), 32+(9*16), 32));
		manager.registerInfoPage("chain_chestplate", new GuideInfoPage("chain_chestplate", EnumPageType.INFO));
		armor.addEntry(new GuideEntry("chain_leggings", "Chain Leggings", new ItemStack(Items.CHAINMAIL_LEGGINGS), 32+(10*16), 32));
		manager.registerInfoPage("chain_leggings", new GuideInfoPage("chain_leggings", EnumPageType.INFO));
		armor.addEntry(new GuideEntry("chain_boots", "Chain Boots", new ItemStack(Items.CHAINMAIL_BOOTS), 32+(11*16), 32));
		manager.registerInfoPage("chain_boots", new GuideInfoPage("chain_boots", EnumPageType.INFO));
		armor.addEntry(new GuideEntry("iron_helmet", "Iron Helmet", new ItemStack(Items.IRON_HELMET), 32+(12*16), 32));
		manager.registerInfoPage("iron_helmet", new GuideInfoPage("iron_helmet", EnumPageType.INFO));
		armor.addEntry(new GuideEntry("iron_chestplate", "Iron Chestplate", new ItemStack(Items.IRON_CHESTPLATE), 32+(13*16), 32));
		manager.registerInfoPage("iron_chestplate", new GuideInfoPage("iron_chestplate", EnumPageType.INFO));
		armor.addEntry(new GuideEntry("iron_leggings", "Iron Leggings", new ItemStack(Items.IRON_LEGGINGS), 32+(14*16), 32));
		manager.registerInfoPage("iron_leggings", new GuideInfoPage("iron_leggings", EnumPageType.INFO));
		armor.addEntry(new GuideEntry("iron_boots", "Iron Boots", new ItemStack(Items.IRON_BOOTS), 32+(15*16), 32));
		manager.registerInfoPage("iron_boots", new GuideInfoPage("iron_boots", EnumPageType.INFO));
		armor.addEntry(new GuideEntry("diamond_helmet", "Diamond Helmet", new ItemStack(Items.DIAMOND_HELMET), 32+(0*16), 58));
		manager.registerInfoPage("diamond_helmet", new GuideInfoPage("diamond_helmet", EnumPageType.INFO));
		armor.addEntry(new GuideEntry("diamond_chestplate", "Diamond Chestplate", new ItemStack(Items.DIAMOND_CHESTPLATE), 32+(1*16), 58));
		manager.registerInfoPage("diamond_chestplate", new GuideInfoPage("diamond_chestplate", EnumPageType.INFO));
		armor.addEntry(new GuideEntry("diamond_leggings", "Diamond Leggings", new ItemStack(Items.DIAMOND_LEGGINGS), 32+(2*16), 58));
		manager.registerInfoPage("diamond_leggings", new GuideInfoPage("diamond_leggings", EnumPageType.INFO));
		armor.addEntry(new GuideEntry("diamond_boots", "Diamond Boots", new ItemStack(Items.DIAMOND_BOOTS), 32+(3*16), 58));
		manager.registerInfoPage("diamond_boots", new GuideInfoPage("diamond_boots", EnumPageType.INFO));
	}
