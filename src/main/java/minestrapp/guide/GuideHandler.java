...
public class GuideHandler {
	...
	public static void preInit(){
		...
		decor.addEntry(new GuideEntry("glass_pane", "Glass Pane", new ItemStack(Blocks.GLASS_PANE), 32+(5*16), 32));
		manager.registerInfoPage("glass_pane", new GuideInfoPage("glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("white_stained_glass_pane", "White Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 0), 32+(6*16), 32));
		manager.registerInfoPage("white_stained_glass_pane", new GuideInfoPage("white_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("light_gray_stained_glass_pane", "Light Gray Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 8), 32+(7*16), 32));
		manager.registerInfoPage("light_gray_stained_glass_pane", new GuideInfoPage("light_gray_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("gray_stained_glass_pane", "Gray Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 7), 32+(8*16), 32));
		manager.registerInfoPage("gray_stained_glass_pane", new GuideInfoPage("gray_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("black_stained_glass_pane", "Black Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 15), 32+(9*16), 32));
		manager.registerInfoPage("black_stained_glass_pane", new GuideInfoPage("black_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("brown_stained_glass_pane", "Brown Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 12), 32+(10*16), 32));
		manager.registerInfoPage("brown_stained_glass_pane", new GuideInfoPage("brown_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("red_stained_glass_pane", "Red Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 14), 32+(11*16), 32));
		manager.registerInfoPage("red_stained_glass_pane", new GuideInfoPage("red_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("orange_stained_glass_pane", "Orange Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 1), 32+(12*16), 32));
		manager.registerInfoPage("orange_stained_glass_pane", new GuideInfoPage("orange_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("yellow_stained_glass_pane", "Yellow Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 4), 32+(13*16), 32));
		manager.registerInfoPage("yellow_stained_glass_pane", new GuideInfoPage("yellow_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("lime_stained_glass_pane", "Lime Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 5), 32+(14*16), 32));
		manager.registerInfoPage("lime_stained_glass_pane", new GuideInfoPage("lime_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("green_stained_glass_pane", "Green Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 13), 32+(15*16), 32));
		manager.registerInfoPage("green_stained_glass_pane", new GuideInfoPage("green_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("cyan_stained_glass_pane", "Cyan Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 9), 32+(0*16), 58));
		manager.registerInfoPage("cyan_stained_glass_pane", new GuideInfoPage("cyan_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("light_blue_stained_glass_pane", "Light Blue Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 3), 32+(1*16), 58));
		manager.registerInfoPage("light_blue_stained_glass_pane", new GuideInfoPage("light_blue_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("blue_stained_glass_pane", "Blue Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 11), 32+(2*16), 58));
		manager.registerInfoPage("blue_stained_glass_pane", new GuideInfoPage("blue_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("purple_stained_glass_pane", "Purple Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 10), 32+(3*16), 58));
		manager.registerInfoPage("purple_stained_glass_pane", new GuideInfoPage("purple_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("magenta_stained_glass_pane", "Magenta Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 2), 32+(4*16), 58));
		manager.registerInfoPage("magenta_stained_glass_pane", new GuideInfoPage("magenta_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("pink_stained_glass_pane", "Pink Stained Glass Pane", new ItemStack(Blocks.STAINED_GLASS_PANE, 1, 6), 32+(5*16), 58));
		manager.registerInfoPage("pink_stained_glass_pane", new GuideInfoPage("pink_stained_glass_pane", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("iron_bars", "Iron Bars", new ItemStack(Blocks.IRON_BARS), 32+(6*16), 58));
		manager.registerInfoPage("iron_bars", new GuideInfoPage("iron_bars", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("oak_fence", "Oak Plank Fence", new ItemStack(Blocks.OAK_FENCE), 32+(7*16), 58));
		manager.registerInfoPage("oak_fence", new GuideInfoPage("oak_fence", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("spruce_fence", "Spruce Plank Fence", new ItemStack(Blocks.SPRUCE_FENCE), 32+(8*16), 58));
		manager.registerInfoPage("spruce_fence", new GuideInfoPage("spruce_fence", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("birch_fence", "Birch Plank Fence", new ItemStack(Blocks.BIRCH_FENCE), 32+(9*16), 58));
		manager.registerInfoPage("birch_fence", new GuideInfoPage("birch_fence", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("jungle_fence", "Jungle Plank Fence", new ItemStack(Blocks.JUNGLE_FENCE), 32+(10*16), 58));
		manager.registerInfoPage("jungle_fence", new GuideInfoPage("jungle_fence", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("acacia_fence", "Acacia Plank Fence", new ItemStack(Blocks.ACACIA_FENCE), 32+(11*16), 58));
		manager.registerInfoPage("acacia_fence", new GuideInfoPage("acacia_fence", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("dark_oak_fence", "Dark Oak Plank Fence", new ItemStack(Blocks.DARK_OAK_FENCE), 32+(12*16), 58));
		manager.registerInfoPage("dark_oak_fence", new GuideInfoPage("dark_oak_fence", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("nether_brick_fence", "Nether Brick Fence", new ItemStack(Blocks.NETHER_BRICK_FENCE), 32+(13*16), 58));
		manager.registerInfoPage("nether_brick_fence", new GuideInfoPage("nether_brick_fence", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("cobblestone_wall", "Cobblestone Wall", new ItemStack(Blocks.COBBLESTONE_WALL, 0, 0), 32+(14*16), 58));
		manager.registerInfoPage("cobblestone_wall", new GuideInfoPage("cobblestone_wall", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("mossy_cobblestone_wall", "Mossy Cobblestone Wall", new ItemStack(Blocks.COBBLESTONE_WALL, 0, 1), 32+(15*16), 58));
		manager.registerInfoPage("mossy_cobblestone_wall", new GuideInfoPage("mossy_cobblestone_wall", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("oak_fence_gate", "Oak Plank Fence Gate", new ItemStack(Blocks.OAK_FENCE_GATE), 32+(0*16), 84));
		manager.registerInfoPage("oak_fence_gate", new GuideInfoPage("oak_fence_gate", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("spruce_fence_gate", "Spruce Plank Fence Gate", new ItemStack(Blocks.SPRUCE_FENCE_GATE), 32+(1*16), 84));
		manager.registerInfoPage("spruce_fence_gate", new GuideInfoPage("spruce_fence_gate", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("birch_fence_gate", "Birch Plank Fence Gate", new ItemStack(Blocks.BIRCH_FENCE_GATE), 32+(2*16), 84));
		manager.registerInfoPage("birch_fence_gate", new GuideInfoPage("birch_fence_gate", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("jungle_fence_gate", "Jungle Plank Fence Gate", new ItemStack(Blocks.JUNGLE_FENCE_GATE), 32+(3*16), 84));
		manager.registerInfoPage("jungle_fence_gate", new GuideInfoPage("jungle_fence_gate", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("acacia_fence_gate", "Acacia Plank Fence Gate", new ItemStack(Blocks.ACACIA_FENCE_GATE), 32+(4*16), 84));
		manager.registerInfoPage("acacia_fence_gate", new GuideInfoPage("acacia_fence_gate", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("dark_oak_fence_gate", "Dark Oak Plank Fence Gate", new ItemStack(Blocks.DARK_OAK_FENCE_GATE), 32+(5*16), 84));
		manager.registerInfoPage("dark_oak_fence_gate", new GuideInfoPage("dark_oak_fence_gate", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("trapdoor", "Wooden Trapdoor", new ItemStack(Blocks.TRAPDOOR), 32+(6*16), 84));
		manager.registerInfoPage("trapdoor", new GuideInfoPage("trapdoor", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("iron_trapdoor", "Iron Trapdoor", new ItemStack(Blocks.IRON_TRAPDOOR), 32+(7*16), 84));
		manager.registerInfoPage("iron_trapdoor", new GuideInfoPage("iron_trapdoor", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("oak_door", "Oak Door", new ItemStack(Items.OAK_DOOR), 32+(8*16), 84));
		manager.registerInfoPage("oak_door", new GuideInfoPage("oak_door", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("spruce_door", "Spruce Door", new ItemStack(Items.SPRUCE_DOOR), 32+(9*16), 84));
		manager.registerInfoPage("spruce_door", new GuideInfoPage("spruce_door", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("birch_door", "Birch Door", new ItemStack(Items.BIRCH_DOOR), 32+(10*16), 84));
		manager.registerInfoPage("birch_door", new GuideInfoPage("birch_door", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("jungle_door", "Jungle Door", new ItemStack(Items.JUNGLE_DOOR), 32+(11*16), 84));
		manager.registerInfoPage("jungle_door", new GuideInfoPage("jungle_door", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("acacia_door", "Acacia Door", new ItemStack(Items.ACACIA_DOOR), 32+(12*16), 84));
		manager.registerInfoPage("acacia_door", new GuideInfoPage("acacia_door", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("dark_oak_door", "Dark Oak Door", new ItemStack(Items.DARK_OAK_DOOR), 32+(13*16), 84));
		manager.registerInfoPage("dark_oak_door", new GuideInfoPage("dark_oak_door", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("iron_door", "Iron Door", new ItemStack(Items.IRON_DOOR), 32+(14*16), 84));
		manager.registerInfoPage("iron_door", new GuideInfoPage("iron_door", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("skull_player", "Human Head", new ItemStack(Items.SKULL, 0, 3), 32+(15*16), 84));
		manager.registerInfoPage("skull_player", new GuideInfoPage("skull_player", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("skull_zombie", "Zombie Head", new ItemStack(Items.SKULL, 0, 2), 32+(0*16), 110));
		manager.registerInfoPage("skull_zombie", new GuideInfoPage("skull_zombie", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("skull_skeleton", "Skeleton Skull", new ItemStack(Items.SKULL, 0, 0), 32+(1*16), 110));
		manager.registerInfoPage("skull_skeleton", new GuideInfoPage("skull_skeleton", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("skull_wither_skeleton", "Wither Skeleton Skull", new ItemStack(Items.SKULL, 0, 1), 32+(2*16), 110));
		manager.registerInfoPage("skull_wither_skeleton", new GuideInfoPage("skull_wither_skeleton", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("skull_creeper", "Creeper Head", new ItemStack(Items.SKULL, 0, 4), 32+(3*16), 110));
		manager.registerInfoPage("skull_creeper", new GuideInfoPage("skull_creeper", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("skull_dragon", "Dragon Head", new ItemStack(Items.SKULL, 0, 5), 32+(4*16), 110));
		manager.registerInfoPage("skull_dragon", new GuideInfoPage("skull_dragon", EnumPageType.INFO));
		decor.addEntry(new GuideEntry("dragon_egg", "Dragon Egg", new ItemStack(Blocks.DRAGON_EGG), 32+(5*16), 110));
		...
		materials.addEntry(new GuideEntry("coal", "Coal", new ItemStack(Items.COAL, 0, 0), 32+(0*16), 32));
		manager.registerInfoPage("coal", new GuideInfoPage("coal", EnumPageType.INFO));
		materials.addEntry(new GuideEntry("charcoal", "Charcoal", new ItemStack(Items.COAL, 0, 1), 32+(1*16), 32));
		...
		food.addEntry(new GuideEntry("cake", "Cake", new ItemStack(Items.CAKE), 32+(1*16), 32));
		manager.registerInfoPage("cake", new GuideInfoPage("cake", EnumPageType.INFO));
		
		tool.addEntry(new GuideEntry("iron_pickaxe", "Iron Pickaxe", new ItemStack(Items.IRON_PICKAXE), 32+(0*16), 32));
		manager.registerInfoPage("iron_pickaxe", new GuideInfoPage("iron_pickaxe", EnumPageType.INFO));
		tool.addEntry(new GuideEntry("iron_axe", "Iron Axe", new ItemStack(Items.IRON_AXE), 32+(1*16), 32));
		manager.registerInfoPage("iron_axe", new GuideInfoPage("iron_axe", EnumPageType.INFO));
		tool.addEntry(new GuideEntry("iron_shovel", "Iron Shovel", new ItemStack(Items.IRON_SHOVEL), 32+(2*16), 32));
		manager.registerInfoPage("iron_shovel", new GuideInfoPage("iron_shovel", EnumPageType.INFO));
		
		special_tool.addEntry(new GuideEntry("flint_and_steel", "Flint and Steel", new ItemStack(Items.FLINT_AND_STEEL), 32+(0*16), 32));
