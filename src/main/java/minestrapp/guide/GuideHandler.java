...
public class GuideHandler {
	...
	public static void preInit(){
		...
		plant.addEntry(new GuideEntry("oak_sapling", "Oak Sapling", new ItemStack(Blocks.SAPLING, 0, 0), 32+(0*16), 32));
		manager.registerInfoPage("oak_sapling", new GuideInfoPage("oak_sapling", EnumPageType.INFO));
		plant.addEntry(new GuideEntry("spruce_sapling", "Spruce Sapling", new ItemStack(Blocks.SAPLING, 0, 1), 32+(1*16), 32));
		manager.registerInfoPage("spruce_sapling", new GuideInfoPage("spruce_sapling", EnumPageType.INFO));
		plant.addEntry(new GuideEntry("birch_sapling", "Birch Sapling", new ItemStack(Blocks.SAPLING, 0, 2), 32+(2*16), 32));
		manager.registerInfoPage("birch_sapling", new GuideInfoPage("birch_sapling", EnumPageType.INFO));
		plant.addEntry(new GuideEntry("jungle_sapling", "Jungle Sapling", new ItemStack(Blocks.SAPLING, 0, 3), 32+(3*16), 32));
		manager.registerInfoPage("jungle_sapling", new GuideInfoPage("jungle_sapling", EnumPageType.INFO));
		plant.addEntry(new GuideEntry("acacia_sapling", "Acacia Sapling", new ItemStack(Blocks.SAPLING, 0, 4), 32+(4*16), 32));
		manager.registerInfoPage("acacia_sapling", new GuideInfoPage("acacia_sapling", EnumPageType.INFO));
		plant.addEntry(new GuideEntry("dark_oak_sapling", "Dark Oak Sapling", new ItemStack(Blocks.SAPLING, 0, 5), 32+(5*16), 32));
		...
		stone.addEntry(new GuideEntry("bedrock", "Bedrock", new ItemStack(Blocks.BEDROCK), 32+(4*16), 32));
